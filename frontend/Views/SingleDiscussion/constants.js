...
export const FETCHING_SINGLE_DISC_SUCCESS =
  "fetching_single_discussion_success";
export const FETCHING_SINGLE_DISC_FAILURE =
  "fetching_single_discussion_failure";
...
export const TOGGLE_OPINION_FAVORITE_START = "toggle_opinion_favorite_start";
export const TOGGLE_OPINION_FAVORITE_SUCCESS =
